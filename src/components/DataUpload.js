    ...
    <Card sx={{ maxWidth: 345, border: '10px grey solid' }}>
          ...
          <div style={{ marginBottom: '50px' }}>
            ...
            <div style={{ marginTop: '50px' }}>
              <Button variant="contained" color="primary" onClick={onUpload} disabled={!file}>
                Upload Data
              </Button>
            </div>
          </div>
        ...
        <DemandForecast/>
            <Typography variant="body2" color="text.secondary">
              Upload data here and get a customised forecaset on how much demand PSA should expect!
            </Typography>
          </CardContent>    
        </Card>
  );
